        ...
        <Menu>
          {({open}) => (
            <>
              <Menu.Button>
                {open ? (
                  <XMarkIcon className="w-9 h-9 text-white absolute top-4 right-4" />
                ) : (
              ...
              >
                <Menu.Items className="absolute top-8 left-0 w-screen h-screen bg-[#16161C] p-10 md:flex flex-col justify-center text-white">
                  <h3 className="font-bold text-2xl xl:text-[32px] mb-8 xl:mb-16">
                    Truecolo
                    <span className="text-[#fe3939]">r</span>
                  </h3>
                  ...
                  <button className="absolute bottom-16 left-8">
                    <svg
                      width="48"
                      height="48"
                      viewBox="0 0 48 48"
