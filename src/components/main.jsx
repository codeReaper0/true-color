...
export default function Main() {
  return (
    <main className="flex-grow h-full">
      ...
      >
        <SwiperSlide>
          <div className="bg-[#B99EE4] w-full h-screen p-4 md:p-[50px] flex flex-col justify-center">
            <h1 className="font-extrabold text-[#16161c] text-lg md:text-2xl lg:text-4xl xl:text-[64px] font-lexend uppercase mb-3 xl:mb-6">
              Make a process that
            </h1>
            <h1 className="font-extrabold   text-lg md:text-2xl lg:text-4xl xl:text-[64px] font-lexend uppercase bg-[#16161c] text-white p-2 w-max">
              is data-driven
            </h1>

            <p className="text-[#16161c] font-semibold mt-6 lg:text-based max-w-4xl">
        ...
        <SwiperSlide>
          <div className="bg-[#64D791] md:w-full h-screen p-4 md:p-[50px] flex flex-col justify-center">
            ...
            <h1 className="font-extrabold   text-lg md:text-2xl lg:text-4xl xl:text-[64px] font-lexend uppercase leading-[40px] md:leading-[55px] lg:leading-[60px] xl:leading-[80px] text-[#16161c]">
        ...
        <SwiperSlide>
          <div className="bg-[#73D3E9] md:w-full h-screen p-4 md:p-[50px] flex flex-col justify-center">
            ...
            <h1 className="font-extrabold   text-lg md:text-2xl lg:text-4xl xl:text-[64px] font-lexend uppercase text-[#16161c]">
              <span>CANDIDATES</span>
              <span className="bg-[#16161c] text-white p-2 w-max ml-3">
                CONDUCT
              </span>
            </h1>
            <h1 className="font-extrabold text-[#16161c]  text-lg md:text-2xl lg:text-4xl xl:text-[64px] font-lexend uppercase mb-3 xl:mb-6  leading-[40px] md:leading-[60px] lg:leading-[80px] xl:leading-[120px]">
              THEMSELVES AT WORK
            </h1>
